...
################################################################
# This is a generated script based on design: ProcessingSystem
#
...
# source ProcessingSystem_script.tcl
...
set design_name ProcessingSystem
...
proc create_root_design { parentCell } {
  ...
  set S_AXIS_STS_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_STS_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
   CONFIG.HAS_TKEEP {1} \
   CONFIG.HAS_TLAST {1} \
  ...
  set M_AXIS_CNTRL_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M_AXIS_CNTRL_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
   ] $M_AXIS_CNTRL_0
...
\
  ...
  connect_bd_intf_net -intf_net S_AXIS_STS_0_1 [get_bd_intf_ports S_AXIS_STS_0] [get_bd_intf_pins axi_dma_0/S_AXIS_STS]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_CNTRL [get_bd_intf_ports M_AXIS_CNTRL_0] [get_bd_intf_pins axi_dma_0/M_AXIS_CNTRL]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins smartconnect_3/S00_AXI] [get_bd_intf_pins axi_dma_0/M_AXI_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_SG [get_bd_intf_pins smartconnect_4/S00_AXI] [get_bd_intf_pins axi_dma_0/M_AXI_SG]
  ...
  connect_bd_intf_net -intf_net smartconnect_2_M00_AXI [get_bd_intf_pins smartconnect_2/M00_AXI] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net smartconnect_3_M00_AXI [get_bd_intf_pins smartconnect_3/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP1]
  connect_bd_intf_net -intf_net smartconnect_4_M00_AXI [get_bd_intf_pins smartconnect_4/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP2]

  # Create port connections
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_ports FCLK_CLK0_0] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_2/aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_3/aclk] [get_bd_pins smartconnect_4/aclk]
  ...
  connect_bd_net -net rst_ps7_0_250M_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins smartconnect_2/aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_3/aresetn] [get_bd_pins smartconnect_4/aresetn] [get_bd_ports FCLK_RESET0_N_0]
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] -force
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs M00_AXI_0/Reg] -force
